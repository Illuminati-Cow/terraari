...
{
    public static bool downedHydrolysistBoss = false;

    // public static bool downedOtherBoss = false;

    public override void ClearWorld()
    {
        downedHydrolysistBoss = false;
    ...
    {
        downedHydrolysistBoss = tag.ContainsKey("downedMinionBoss");
    ...
    public override void NetSend(BinaryWriter writer)
    {
        ...
        writer.WriteFlags(
            downedHydrolysistBoss /*, downedOtherBoss*/
        );
    ...
    public override void NetReceive(BinaryReader reader)
    {
        ...
        reader.ReadFlags(
            out downedHydrolysistBoss /*, out downedOtherBoss*/
        );
